...
- **Package**: `io.github.smeltery.hermes`
...
- **Package**: `io.github.smeltery.hermes.core`
...
- **Package**: `io.github.smeltery.hermes.processor`
...
- **Package**: `io.github.smeltery.hermes.spring`
...
- **Package**: `io.github.smeltery.hermes.kotlin`
...
1. Create class implementing `io.github.smeltery.hermes.core.appender.Appender` interface
2. Implement `append(LogEvent)`, `start()`, `stop()`, `isStarted()` methods
3. Add lifecycle management (start/stop) in constructor
4. Location: `hermes-core/src/main/java/io/github/smeltery/hermes/core/appender/`

### Adding a New Layout
1. Create class implementing `io.github.smeltery.hermes.core.layout.Layout` interface
2. Implement `format(LogEvent)` method to return formatted string
3. Location: `hermes-core/src/main/java/io/github/smeltery/hermes/core/layout/`

### Modifying Log Levels
Log levels are defined in `hermes-api/src/main/java/io/github/smeltery/hermes/LogLevel.java` enum. Changes here affect the entire API contract.

### Working with MDC
MDC is thread-local storage managed in `hermes-api/src/main/java/io/github/smeltery/hermes/MDC.java`. Changes must maintain thread-safety.
...
- API interfaces: `hermes-api/src/main/java/io/github/smeltery/hermes/`
- Core implementation: `hermes-core/src/main/java/io/github/smeltery/hermes/core/`
- Appenders: `hermes-core/src/main/java/io/github/smeltery/hermes/core/appender/`
- Layouts: `hermes-core/src/main/java/io/github/smeltery/hermes/core/layout/`
- Annotation processor: `hermes-processor/src/main/java/io/github/smeltery/hermes/processor/`
- Spring Boot: `hermes-spring-boot-starter/src/main/java/io/github/smeltery/hermes/spring/`
- Kotlin DSL: `hermes-kotlin/src/main/kotlin/io/github/smeltery/hermes/kotlin/`
