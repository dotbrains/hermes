...
export function CTASection() {
  return (
    <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-hermes-blue/10 via-dark-slate to-dark-slate">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center">
        ...
        <div className="grid sm:grid-cols-3 gap-4 sm:gap-6">
          ...
          >
            <div className="w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-hermes-blue to-hermes-purple rounded-lg flex items-center justify-center mx-auto mb-3 sm:mb-4 group-hover:scale-110 transition-transform">
          ...
          >
            <div className="w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-hermes-purple to-hermes-cyan rounded-lg flex items-center justify-center mx-auto mb-3 sm:mb-4 group-hover:scale-110 transition-transform">
          ...
          >
            <div className="w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-hermes-cyan to-hermes-blue rounded-lg flex items-center justify-center mx-auto mb-3 sm:mb-4 group-hover:scale-110 transition-transform">
